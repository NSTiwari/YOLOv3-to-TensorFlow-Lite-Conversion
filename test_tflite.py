...
def draw_boxes(boxes, classes, scores, img, cls_names, detection_size, is_letter_box_image):
    ...
    font = ImageFont.truetype(r'assets/Lato-Regular.ttf', 30)  
...
model_path = os.path.join(os.getcwd(), 'assets/detect.tflite')
...
img = Image.open('assets/test_image.jpg')
...
boxes, classes, scores = handle_predictions(predictions[0],
                                            confidence=0.3,
                                            iou_threshold=0.5)
class_names = load_label_files("assets/classes.names")
